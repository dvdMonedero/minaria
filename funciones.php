    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        if (!isset($edificios[$idEdificio])) {
            $edificios[$idEdificio] = [
                ...
                'nombre' => $row['nombre'],
                'coste_piedra' => $row['coste_piedra'] * $row['multiplicador_coste'],
                'coste_metal' => $row['coste_metal'] * $row['multiplicador_coste'],
                'coste_madera' => $row['coste_madera'] * $row['multiplicador_coste'],
                'coste_comida' => $row['coste_comida'] * $row['multiplicador_coste'],
                'coste_oro' => $row['coste_oro'] * $row['multiplicador_coste'],
                'coste_magia' => $row['coste_magia'] * $row['multiplicador_coste'],
